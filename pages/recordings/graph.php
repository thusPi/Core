...
<div class="graph-container transition-slide-top transparent-selection flex-row" data-status="loading">
	...
	<div class="graph-sidebar tile col-auto">
		<div class="tile-content">
			<div class="graph-sidebar-items-group flex-column">
				...
				<div class="graph-sidebar-item">
					<?php echo(create_icon([
						'icon'       => 'far.layer-plus', 
						'scale'      => 'md', 
						'classes'    => ['graph-sidebar-item-icon', 'text-blue'],
						'attributes' => [
				...
				<div class="graph-sidebar-item">
					...
					<div class="graph-sidebar-item-main flex-column">
						<input type="text" data-type="search" name="graph_interval">
						<ul class="input-search-results" for="graph_interval">
							<li value="recording" selected><?php echo(\thusPi\Locale\translate('recordings.graph.sidebar.item.interval.per_recording')); ?></li>
							<li value="hour" onclick="thusPi.recordings.graph.drawInterval('hour');"><?php echo(\thusPi\Locale\translate('generic.interval.hour_per')); ?></li>
							<li value="day" onclick="thusPi.recordings.graph.drawInterval('day');"><?php echo(\thusPi\Locale\translate('generic.interval.day_per')); ?></li>
							<li value="week" onclick="thusPi.recordings.graph.drawInterval('week');"><?php echo(\thusPi\Locale\translate('generic.interval.week_per')); ?></li>
							<li value="month" onclick="thusPi.recordings.graph.drawInterval('month');"><?php echo(\thusPi\Locale\translate('generic.interval.month_per')); ?></li>
							<li value="year" onclick="thusPi.recordings.graph.drawInterval('year');"><?php echo(\thusPi\Locale\translate('generic.interval.year_per')); ?></li>
						</ul>
					</div>
				</div>
				<!-- Period -->
				<div class="graph-sidebar-item">
					...
					<div class="graph-sidebar-item-main flex-column">
						...
						<ul class="input-search-results" for="graph_period">
							<li value="hour" onclick="thusPi.recordings.graph.selectPeriod('hour');"><?php echo(\thusPi\Locale\translate('generic.period.hour')); ?></li>
							<li value="day" onclick="thusPi.recordings.graph.selectPeriod('day');"><?php echo(\thusPi\Locale\translate('generic.period.day')); ?></li>
							<li value="week" onclick="thusPi.recordings.graph.selectPeriod('week');"><?php echo(\thusPi\Locale\translate('generic.period.week')); ?></li>
							<li value="month" onclick="thusPi.recordings.graph.selectPeriod('month');"><?php echo(\thusPi\Locale\translate('generic.period.month')); ?></li>
							<li value="year" onclick="thusPi.recordings.graph.selectPeriod('year');"><?php echo(\thusPi\Locale\translate('generic.period.year')); ?></li>
							<li value="other" selected><?php echo(\thusPi\Locale\translate('generic.state.all')); ?></li>
						</ul>
						<div class="flex-row">
